...
def demo():
    ...
    print("  • Entanglement key: ~869B plaintext → ~240B sealed")
    print("  • Shard_ids: IN the key (leaked) → REMOVED (derived from entity_id)")
    print("  • Shard storage: plaintext → AEAD-encrypted ciphertext")
    print("  • Key envelope: none → sealed to receiver's public key")
    print("  • Commitment record: listed shard_ids → Merkle root only")
    print()
    print("  The data didn't move. The proof moved. The truth materialized.")
    print("  And no one else could see it happen.")
    print("=" * 74)
